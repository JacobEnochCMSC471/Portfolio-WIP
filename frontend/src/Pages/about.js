      ...
      <div class="split left">
        <div class='left-header'>
          <div class='centered-text'>
            ...
            <div class="vid-text">
              <a href="https://github.com/JacobEnochCMSC471/Score-Board-RGB" class="special-link-about"  target="_blank" rel="noreferrer"><p> An Arduino Scoreboard program written in C++. </p> </a>
            </div>
            <video controls class="video">
              <source src={demoVideo2} type="video/mp4" />
            </video>
            <div class="vid-text">
              <a href="https://github.com/JacobEnochCMSC471/CMSC447-Project-IRL-Pokemon-Go" class="special-link-about" target="_blank" rel="noreferrer"><p> A Pokemon Go-like webgame made with a 5 person team using Django and Agile methodology. </p> </a>
            </div>
          </div>
        </div>
      </div>
